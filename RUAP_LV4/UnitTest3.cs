...
namespace SeleniumTests
{
    ...
    public class UntitledTestCase
    {
        ...
        public void TheUntitledTestCaseTest()
        {
            ...
            driver.FindElement(By.Id("input-name")).SendKeys("Adrian");
            driver.FindElement(By.Id("input-email")).Clear();
            driver.FindElement(By.Id("input-email")).SendKeys("adrian2000@gmail");
            driver.FindElement(By.Id("input-enquiry")).Clear();
            driver.FindElement(By.Id("input-enquiry")).SendKeys("When will the product xyz come on sale?");
